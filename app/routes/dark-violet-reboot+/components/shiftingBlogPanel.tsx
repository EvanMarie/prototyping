  ...
  return (
    ...
    >
      <VStackFull className="p-[1vh] sm:p-[2vh] flex-col items-center gap-[2vh] bg-cyan-700/60 bg-gradient-to-b from-indigo-900-75 to-purple-900-75 border-970-md shadowBroadNormal md:w-[73vh] xl:w-full xl:max-h-[80vh] xxl:w-[80vw]">
        <VStackFull gap="gap-[1vh]" className="text-center">
          <VStackFull gap="gap-[1vh]">
            <Text className="text-cyan-300 sm:text-[2.3vh] xl:text-[3vh] textShadow">
              {blog.title}
            </Text>
            <HStackFull className="justify-between xl:justify-center xl:gap-[3vh] px-[2vh] sm:text-[2vh] md:px-[4vh] py-[1vh] md:text-[2.3vh] xl:text-[3vh] xl:w-60%">
            ...
            >
              ...
              {blog.image && (
                <CenterHorizontalFull className="">
                  <Box className="w-[70vw] h-[70vw] sm:w-[60vw] sm:h-[60vw] md:w-[40vh] md:h-[40vh] xl:w-[50vh] xl:h-[50vh] border-970-md shadowBroadNormal">
                    <Image
                      src={blog.image}
                      alt={blog.title}
