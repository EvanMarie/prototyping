...
export default {
  ...
  theme: {
    extend: {
      colors: {
        col: {
          100: "rgba(242, 227, 213, 1)",
          110: "rgba(242, 227, 213, 0.1)",
          120: "rgba(242, 227, 213, 0.2)",
          130: "rgba(242, 227, 213, 0.3)",
          140: "rgba(242, 227, 213, 0.4)",
          150: "rgba(242, 227, 213, 0.5)",
          160: "rgba(242, 227, 213, 0.6)",
          170: "rgba(242, 227, 213, 0.7)",
          180: "rgba(242, 227, 213, 0.8)",
          190: "rgba(242, 227, 213, 0.9)",

          200: "rgba(208, 180, 167, 1)",
          210: "rgba(208, 180, 167, 0.1)",
          220: "rgba(208, 180, 167, 0.2)",
          230: "rgba(208, 180, 167, 0.3)",
          240: "rgba(208, 180, 167, 0.4)",
          250: "rgba(208, 180, 167, 0.5)",
          260: "rgba(208, 180, 167, 0.6)",
          270: "rgba(208, 180, 167, 0.7)",
          280: "rgba(208, 180, 167, 0.8)",
          290: "rgba(208, 180, 167, 0.9)",

          300: "rgba(207, 142, 101, 1)",
          310: "rgba(207, 142, 101, 0.1)",
          320: "rgba(207, 142, 101, 0.2)",
          330: "rgba(207, 142, 101, 0.3)",
          340: "rgba(207, 142, 101, 0.4)",
          350: "rgba(207, 142, 101, 0.5)",
          360: "rgba(207, 142, 101, 0.6)",
          370: "rgba(207, 142, 101, 0.7)",
          380: "rgba(207, 142, 101, 0.8)",
          390: "rgba(207, 142, 101, 0.9)",

          400: "rgba(139, 108, 89, 1)",
          410: "rgba(139, 108, 89, 0.1)",
          420: "rgba(139, 108, 89, 0.2)",
          430: "rgba(139, 108, 89, 0.3)",
          440: "rgba(139, 108, 89, 0.4)",
          450: "rgba(139, 108, 89, 0.5)",
          460: "rgba(139, 108, 89, 0.6)",
          470: "rgba(139, 108, 89, 0.7)",
          480: "rgba(139, 108, 89, 0.8)",
          490: "rgba(139, 108, 89, 0.9)",

          500: "rgba(161, 101, 100, 1)",
          510: "rgba(161, 101, 100, 0.1)",
          520: "rgba(161, 101, 100, 0.2)",
          530: "rgba(161, 101, 100, 0.3)",
          540: "rgba(161, 101, 100, 0.4)",
          550: "rgba(161, 101, 100, 0.5)",
          560: "rgba(161, 101, 100, 0.6)",
          570: "rgba(161, 101, 100, 0.7)",
          580: "rgba(161, 101, 100, 0.8)",
          590: "rgba(161, 101, 100, 0.9)",

          600: "rgba(140, 56, 55, 1)",
          610: "rgba(140, 56, 55, 0.1)",
          620: "rgba(140, 56, 55, 0.2)",
          630: "rgba(140, 56, 55, 0.3)",
          640: "rgba(140, 56, 55, 0.4)",
          650: "rgba(140, 56, 55, 0.5)",
          660: "rgba(140, 56, 55, 0.6)",
          670: "rgba(140, 56, 55, 0.7)",
          680: "rgba(140, 56, 55, 0.8)",
          690: "rgba(140, 56, 55, 0.9)",

          700: "rgba(98, 54, 55, 1)",
          710: "rgba(98, 54, 55, 0.1)",
          720: "rgba(98, 54, 55, 0.2)",
          730: "rgba(98, 54, 55, 0.3)",
          740: "rgba(98, 54, 55, 0.4)",
          750: "rgba(98, 54, 55, 0.5)",
          760: "rgba(98, 54, 55, 0.6)",
          770: "rgba(98, 54, 55, 0.7)",
          780: "rgba(98, 54, 55, 0.8)",
          790: "rgba(98, 54, 55, 0.9)",

          800: "rgba(77, 15, 15, 1)",
          810: "rgba(77, 15, 15, 0.1)",
          820: "rgba(77, 15, 15, 0.2)",
          830: "rgba(77, 15, 15, 0.3)",
          840: "rgba(77, 15, 15, 0.4)",
          850: "rgba(77, 15, 15, 0.5)",
          860: "rgba(77, 15, 15, 0.6)",
          870: "rgba(77, 15, 15, 0.7)",
          880: "rgba(77, 15, 15, 0.8)",
          890: "rgba(77, 15, 15, 0.9)",
      ...
      boxShadow: {
        ...
        metallicEdgesMd:
          "#000 0.1vh 0.1vh 0.1vh, white 0px 0px 0.1vh, rgb(208, 180, 167) 0px 0px 0.2vh, #00FFFF 0px 0px 0.3vh, #FFF 0px 0px 0.4vh, #e3fcf9 0px 0px 0.5vh, #e3fcf9 0px 0px 0.6vh, 0.8vh 0.2vh 0.6vh rgba(0,0,0,0);",
        metallicEdgesLg:
      ...
      textShadow: {
        ...
        textGlow:
          "#00FFFF 0px 0px 0.5vh, #00FFFF 0px 0px 1vh, #FFF 0px 0px 1.5vh, rgb(208, 180, 167) 0px 0px 1vh, rgb(208, 180, 167) 0px 0px 1vh, 0.8vh 0.2vh 0.6vh rgba(0,0,0,0);",
        boldText:
      ...
      backgroundImage: {
        // FadeOut Gradients
        fadeOut900Op07:
          "radial-gradient(circle, rgba(26, 7, 7, 0.7), rgba(26, 7, 7, 0))",
        fadeOut900Op05:
          "radial-gradient(circle, rgba(26, 7, 7, 0.5), rgba(26, 7, 7, 0))",
        fadeOut900Op03:
          "radial-gradient(circle, rgba(26, 7, 7, 0.3), rgba(26, 7, 7, 0))",
        fadeOut800Op07:
          "radial-gradient(circle, rgba(77, 15, 15, 0.7), rgba(77, 15, 15, 0))",
        fadeOut800Op05:
          "radial-gradient(circle, rgba(77, 15, 15, 0.5), rgba(77, 15, 15, 0))",
        fadeOut800Op03:
          "radial-gradient(circle, rgba(77, 15, 15, 0.3), rgba(77, 15, 15, 0))",
        fadeOut700Op07:
          "radial-gradient(circle, rgba(98, 54, 55, 0.7), rgba(98, 54, 55, 0))",
        fadeOut700Op05:
          "radial-gradient(circle, rgba(98, 54, 55, 0.5), rgba(98, 54, 55, 0))",
        fadeOut700Op03:
          "radial-gradient(circle, rgba(98, 54, 55, 0.3), rgba(98, 54, 55, 0))",
        fadeOut600Op07:
          "radial-gradient(circle, rgba(140, 56, 55, 0.7), rgba(140, 56, 55, 0))",
        fadeOut600Op05:
          "radial-gradient(circle, rgba(140, 56, 55, 0.5), rgba(140, 56, 55, 0))",
        fadeOut600Op03:
          "radial-gradient(circle, rgba(140, 56, 55, 0.3), rgba(140, 56, 55, 0))",
        fadeOut500Op07:
          "radial-gradient(circle, rgba(161, 101, 100, 0.7), rgba(161, 101, 100, 0))",
        fadeOut500Op05:
          "radial-gradient(circle, rgba(161, 101, 100, 0.5), rgba(161, 101, 100, 0))",
        fadeOut500Op03:
          "radial-gradient(circle, rgba(161, 101, 100, 0.3), rgba(161, 101, 100, 0))",
        fadeOut400Op07:
          "radial-gradient(circle, rgba(139, 108, 89, 0.7), rgba(139, 108, 89, 0))",
        fadeOut400Op05:
          "radial-gradient(circle, rgba(139, 108, 89, 0.5), rgba(139, 108, 89, 0))",
        fadeOut400Op03:
          "radial-gradient(circle, rgba(139, 108, 89, 0.3), rgba(139, 108, 89, 0))",
        fadeOut300Op07:
          "radial-gradient(circle, rgba(207, 142, 101, 0.7), rgba(207, 142, 101, 0))",
        fadeOut300Op05:
          "radial-gradient(circle, rgba(207, 142, 101, 0.5), rgba(207, 142, 101, 0))",
        fadeOut300Op03:
          "radial-gradient(circle, rgba(207, 142, 101, 0.3), rgba(207, 142, 101, 0))",
        fadeOut200Op07:
          "radial-gradient(circle, rgba(208, 180, 167, 0.7), rgba(208, 180, 167, 0))",
        fadeOut200Op05:
          "radial-gradient(circle, rgba(208, 180, 167, 0.5), rgba(208, 180, 167, 0))",
        fadeOut200Op03:
          "radial-gradient(circle, rgba(208, 180, 167, 0.3), rgba(208, 180, 167, 0))",
        fadeOut100Op07:
          "radial-gradient(circle, rgba(242, 227, 213, 0.7), rgba(242, 227, 213, 0))",
        fadeOut100Op05:
          "radial-gradient(circle, rgba(242, 227, 213, 0.5), rgba(242, 227, 213, 0))",
        fadeOut100Op03:
          "radial-gradient(circle, rgba(242, 227, 213, 0.3), rgba(242, 227, 213, 0))",
        // Linear Gradients
        linear1:
          "linear-gradient(to top, rgba(242, 227, 213, 1), rgba(208, 180, 167, 1))",
        linear1op25:
          "linear-gradient(to top, rgba(242, 227, 213, 0.25), rgba(208, 180, 167, 0.25))",
        linear1op50:
          "linear-gradient(to top, rgba(242, 227, 213, 0.5), rgba(208, 180, 167, 0.5))",
        linear1op75:
          "linear-gradient(to top, rgba(242, 227, 213, 0.75), rgba(208, 180, 167, 0.75))",

        linear2:
          "linear-gradient(to bottom, rgba(207, 142, 101, 1), rgba(139, 108, 89, 1))",
        linear2op25:
          "linear-gradient(to bottom, rgba(207, 142, 101, 0.25), rgba(139, 108, 89, 0.25))",
        linear2op50:
          "linear-gradient(to bottom, rgba(207, 142, 101, 0.5), rgba(139, 108, 89, 0.5))",
        linear2op75:
          "linear-gradient(to bottom, rgba(207, 142, 101, 0.75), rgba(139, 108, 89, 0.75))",

        linear3:
          "linear-gradient(to right, rgba(161, 101, 100, 1), rgba(140, 56, 55, 1))",
        linear3op25:
          "linear-gradient(to right, rgba(161, 101, 100, 0.25), rgba(140, 56, 55, 0.25))",
        linear3op50:
          "linear-gradient(to right, rgba(161, 101, 100, 0.5), rgba(140, 56, 55, 0.5))",
        linear3op75:
          "linear-gradient(to right, rgba(161, 101, 100, 0.75), rgba(140, 56, 55, 0.75))",

        linear4:
          "linear-gradient(to left, rgba(98, 54, 55, 1), rgba(140, 56, 55, 1))",
        linear4op25:
          "linear-gradient(to left, rgba(98, 54, 55, 0.25), rgba(140, 56, 55, 0.25))",
        linear4op50:
          "linear-gradient(to left, rgba(98, 54, 55, 0.5), rgba(140, 56, 55, 0.5))",
        linear4op75:
          "linear-gradient(to left, rgba(98, 54, 55, 0.75), rgba(140, 56, 55, 0.75))",

        linear5:
          "linear-gradient(to top, rgba(140, 56, 55, 1), rgba(98, 54, 55, 1))",
        linear5op25:
          "linear-gradient(to top, rgba(140, 56, 55, 0.25), rgba(98, 54, 55, 0.25))",
        linear5op50:
          "linear-gradient(to top, rgba(140, 56, 55, 0.5), rgba(98, 54, 55, 0.5))",
        linear5op75:
          "linear-gradient(to top, rgba(140, 56, 55, 0.75), rgba(98, 54, 55, 0.75))",

        linear6:
          "linear-gradient(to bottom, rgba(77, 15, 15, 1), rgba(26, 7, 7, 1))",
        linear6op25:
          "linear-gradient(to bottom, rgba(77, 15, 15, 0.25), rgba(26, 7, 7, 0.25))",
        linear6op50:
          "linear-gradient(to bottom, rgba(77, 15, 15, 0.5), rgba(26, 7, 7, 0.5))",
        linear6op75:
          "linear-gradient(to bottom, rgba(77, 15, 15, 0.75), rgba(26, 7, 7, 0.75))",

        // Diagonal Gradients
        diagonal1:
          "linear-gradient(45deg, rgba(242, 227, 213, 1), rgba(207, 142, 101, 1))",
        diagonal1op25:
          "linear-gradient(45deg, rgba(242, 227, 213, 0.25), rgba(207, 142, 101, 0.25))",
        diagonal1op50:
          "linear-gradient(45deg, rgba(242, 227, 213, 0.5), rgba(207, 142, 101, 0.5))",
        diagonal1op75:
          "linear-gradient(45deg, rgba(242, 227, 213, 0.75), rgba(207, 142, 101, 0.75))",

        diagonal2:
          "linear-gradient(45deg, rgba(208, 180, 167, 1), rgba(139, 108, 89, 1))",
        diagonal2op25:
          "linear-gradient(45deg, rgba(208, 180, 167, 0.25), rgba(139, 108, 89, 0.25))",
        diagonal2op50:
          "linear-gradient(45deg, rgba(208, 180, 167, 0.5), rgba(139, 108, 89, 0.5))",
        diagonal2op75:
          "linear-gradient(45deg, rgba(208, 180, 167, 0.75), rgba(139, 108, 89, 0.75))",

        diagonal3:
          "linear-gradient(45deg, rgba(161, 101, 100, 1), rgba(98, 54, 55, 1))",
        diagonal3op25:
          "linear-gradient(45deg, rgba(161, 101, 100, 0.25), rgba(98, 54, 55, 0.25))",
        diagonal3op50:
          "linear-gradient(45deg, rgba(161, 101, 100, 0.5), rgba(98, 54, 55, 0.5))",
        diagonal3op75:
          "linear-gradient(45deg, rgba(161, 101, 100, 0.75), rgba(98, 54, 55, 0.75))",

        diagonal4:
          "linear-gradient(45deg, rgba(140, 56, 55, 1), rgba(77, 15, 15, 1))",
        diagonal4op25:
          "linear-gradient(45deg, rgba(140, 56, 55, 0.25), rgba(77, 15, 15, 0.25))",
        diagonal4op50:
          "linear-gradient(45deg, rgba(140, 56, 55, 0.5), rgba(77, 15, 15, 0.5))",
        diagonal4op75:
          "linear-gradient(45deg, rgba(140, 56, 55, 0.75), rgba(77, 15, 15, 0.75))",

        diagonal5:
          "linear-gradient(45deg, rgba(207, 142, 101, 1), rgba(161, 101, 100, 1))",
        diagonal5op25:
          "linear-gradient(45deg, rgba(207, 142, 101, 0.25), rgba(161, 101, 100, 0.25))",
        diagonal5op50:
          "linear-gradient(45deg, rgba(207, 142, 101, 0.5), rgba(161, 101, 100, 0.5))",
        diagonal5op75:
          "linear-gradient(45deg, rgba(207, 142, 101, 0.75), rgba(161, 101, 100, 0.75))",

        diagonal6:
          "linear-gradient(45deg, rgba(139, 108, 89, 1), rgba(140, 56, 55, 1))",
        diagonal6op25:
          "linear-gradient(45deg, rgba(139, 108, 89, 0.25), rgba(140, 56, 55, 0.25))",
        diagonal6op50:
          "linear-gradient(45deg, rgba(139, 108, 89, 0.5), rgba(140, 56, 55, 0.5))",
        diagonal6op75:
          "linear-gradient(45deg, rgba(139, 108, 89, 0.75), rgba(140, 56, 55, 0.75))",

        // Radial Gradients
        radial1:
          "radial-gradient(circle, rgba(208, 180, 167, 1) 0%, rgba(139, 108, 89, 1) 100%)",
        radial1op25:
          "radial-gradient(circle, rgba(208, 180, 167, 0.25) 0%, rgba(139, 108, 89, 0.25) 100%)",
        radial1op50:
          "radial-gradient(circle, rgba(208, 180, 167, 0.5) 0%, rgba(139, 108, 89, 0.5) 100%)",
        radial1op75:
          "radial-gradient(circle, rgba(208, 180, 167, 0.75) 0%, rgba(139, 108, 89, 0.75) 100%)",

        radial2:
          "radial-gradient(circle, rgba(207, 142, 101, 1) 0%, rgba(139, 108, 89, 1) 100%)",
        radial2op25:
          "radial-gradient(circle, rgba(207, 142, 101, 0.25) 0%, rgba(139, 108, 89, 0.25) 100%)",
        radial2op50:
          "radial-gradient(circle, rgba(207, 142, 101, 0.5) 0%, rgba(139, 108, 89, 0.5) 100%)",
        radial2op75:
          "radial-gradient(circle, rgba(207, 142, 101, 0.75) 0%, rgba(139, 108, 89, 0.75) 100%)",

        radial3:
          "radial-gradient(circle, rgba(161, 101, 100, 1) 0%, rgba(140, 56, 55, 1) 100%)",
        radial3op25:
          "radial-gradient(circle, rgba(161, 101, 100, 0.25) 0%, rgba(140, 56, 55, 0.25) 100%)",
        radial3op50:
          "radial-gradient(circle, rgba(161, 101, 100, 0.5) 0%, rgba(140, 56, 55, 0.5) 100%)",
        radial3op75:
          "radial-gradient(circle, rgba(161, 101, 100, 0.75) 0%, rgba(140, 56, 55, 0.75) 100%)",

        radial4:
          "radial-gradient(circle, rgba(139, 108, 89, 1) 0%, rgba(208, 180, 167, 1) 100%)",
        radial4op25:
          "radial-gradient(circle, rgba(139, 108, 89, 0.25) 0%, rgba(208, 180, 167, 0.25) 100%)",
        radial4op50:
          "radial-gradient(circle, rgba(139, 108, 89, 0.5) 0%, rgba(208, 180, 167, 0.5) 100%)",
        radial4op75:
          "radial-gradient(circle, rgba(139, 108, 89, 0.75) 0%, rgba(208, 180, 167, 0.75) 100%)",

        radial5:
          "radial-gradient(circle, rgba(161, 101, 100, 1) 0%, rgba(207, 142, 101, 1) 100%)",
        radial5op50:
          "radial-gradient(circle, rgba(161, 101, 100, 0.5) 0%, rgba(207, 142, 101, 0.5) 100%)",
        radial5op75:
          "radial-gradient(circle, rgba(161, 101, 100, 0.75) 0%, rgba(207, 142, 101, 0.75) 100%)",

        radial6:
          "radial-gradient(circle, rgba(98, 54, 55, 1) 0%, rgba(77, 15, 15, 1) 100%)",
        radial6op25:
          "radial-gradient(circle, rgba(98, 54, 55, 0.25) 0%, rgba(77, 15, 15, 0.25) 100%)",
        radial6op50:
          "radial-gradient(circle, rgba(98, 54, 55, 0.5) 0%, rgba(77, 15, 15, 0.5) 100%)",
        radial6op75:
          "radial-gradient(circle, rgba(98, 54, 55, 0.75) 0%, rgba(77, 15, 15, 0.75) 100%)",
      },
      borderRadius: {
        xxs: "0.3vh",
        xs: "0.5vh",
